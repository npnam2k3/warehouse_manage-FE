...
const ModalDetailCustomerDebt = ({ customerDebt, open, setOpen }) => {
  ...
  return (
    ...
    >
      <DialogTitle>
        Chi tiết công nợ khách hàng: <strong>{customerDebt?.fullname}</strong>
        <IconButton
          aria-label="close"
          onClick={handleClose}
          sx={{
      ...
      <DialogContent dividers>
        <Card variant="outlined">
          <CardContent>
            ...
            {customerDebt?.exportOrders?.length ? (
              <Table>
                <TableHead>
                  <TableRow>
                    <TableCell />
                ...
                <TableBody>
                  {customerDebt?.exportOrders?.map((order) => (
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              {order?.export_order_details?.length ? (
                                <Table size="small">
                                  <TableHead>
                                    <TableRow>
                                      <TableCell align="center">
                                  ...
                                  <TableBody>
                                    {order?.export_order_details?.map(
                                      (product, index) => (
                                        <TableRow key={index}>
                                          <TableCell align="center">
                                    ...
                                    <TableRow sx={{ fontWeight: "bold" }}>
                                      ...
                                      <TableCell align="center">
                                        <strong>
                                          {order?.export_order_details?.reduce(
                                            (sum, p) =>
...
export default ModalDetailCustomerDebt;
