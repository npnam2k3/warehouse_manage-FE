...
import { cancelImportOrder } from "../../../apis/importOrderService";
...
const ModalCancelImportOrder = ({
  ...
  const handleClickSave = async () => {
    ...
    try {
      const res = await cancelImportOrder(payload);
  ...
  return (
    <>
      ...
      >
        ...
        >
          {`Hủy hóa đơn có mã: ${import_order?.import_order_code}`}
        </DialogTitle>
        <IconButton
          aria-label="close"
          sx={(theme) => ({
...
export default ModalCancelImportOrder;
